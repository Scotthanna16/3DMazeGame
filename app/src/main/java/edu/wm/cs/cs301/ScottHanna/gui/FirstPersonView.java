...
import edu.wm.cs.cs301.ScottHanna.generation.BSPBranch;
import edu.wm.cs.cs301.ScottHanna.generation.BSPLeaf;
import edu.wm.cs.cs301.ScottHanna.generation.BSPNode;
...
public class FirstPersonView {
	...
	public void draw(MazePanel panel, int x, int y, int walkStep, int ang, float percentToExit) {
        ...
        */
        ...
        drawBackground(gc, percentToExit);
        // set color to white and draw what ever can be seen from the current position
        gc.setColor(ColorTheme.getColor(MazeColors.FIRSTPERSON_DEFAULT).toArgb());
