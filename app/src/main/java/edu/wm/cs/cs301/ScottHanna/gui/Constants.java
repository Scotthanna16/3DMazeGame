...
public class Constants {
	...
	public static final int MAP_UNIT = 300;
	...
	//Change level 0 to 6 for testing
	...
	// Possible user input  
	public enum UserInput {RETURNTOTITLE, START, UP, DOWN, LEFT, RIGHT, JUMP, TOGGLELOCALMAP, TOGGLEFULLMAP, TOGGLESOLUTION, ZOOMIN, ZOOMOUT,WIZARD }
